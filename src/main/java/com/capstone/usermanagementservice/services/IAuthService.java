...
public interface IAuthService {
    ...
    UserModel signup(String email, String password, String firstName, String lastName, String phoneNumber)throws UserAlreadyExistsException,JsonProcessingException;
